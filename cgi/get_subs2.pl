...
my $req = HTTP::Request->new(GET => "https://api.gocardless.com/subscriptions");
#my $req = HTTP::Request->new(GET => "https://gocardless.com/api/v1/merchants/$Merchant_id/subscriptions");
$req->header('Content-Type' => 'text/plain');
$req->header('Content-Length' => '0');
$req->header('Accept' => 'application/json');
$req->header('GoCardless-Version' => '2015-07-06');
$req->header('Authorization' => "Bearer $App_key");
