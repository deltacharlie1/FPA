    ...
    <div class="m whitecontainer">
     ...
     <?php endif; ?>
      ...
      <div class="rightcol">
		...
		</ul><img alt="Approved" class="break" src="/wp-content/themes/freeplusaccounts/images/title-approved.jpg" /><ul>			<div id= "approvedmore" class="textwidget">The Institute of Certified Bookkeepers has tested and approved FreePlus Accounts for use by small businesses and sole traders.&nbsp;&nbsp;They were particularly impressed by the simplicity and ease of use of the system - read the full review <a href="#">here</a>.</div>
		</ul>        
