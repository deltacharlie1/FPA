...
#fpss-outer-container {margin:0px auto;padding:0px;overflow:hidden;width:<?php echo $width+$sidebar_width; ?>px;height:<?php echo $height; ?>px;}
...
#navi-outer li a {
	...
	font-size:11px;
	color:#fff;
	background:#505050 url(nav.gif) repeat-x bottom;
...
#navi-outer li a.navi-active {
	...
	font-size:11px;
	color:#fff;
	background:#d2d2d2 url(nav-active.gif) repeat-x bottom;
