...
//            .css('left', left)
	    .css({ 'width': ($input.outerWidth() + arrowWidth - 2) + 'px', 'top': $input.outerHeight(), 'left': left })
...
//  move this to immediately before the json call                    var params = { q: q, x: document.getElementById('searchtype').value, p: p, s: pageSize, contentType: 'application/json; charset=utf-8' };
                    ...
                    if (o.param.length > 0) {
                      ...
                      add_param = document.getElementById('dfg').title;
                    }
                    var params = { q: q, x: add_param, p: p, s: pageSize, contentType: 'application/json; charset=utf-8' };
	...
	param: '',	  //  Parameter to be passed to the called routine
        paging: {
