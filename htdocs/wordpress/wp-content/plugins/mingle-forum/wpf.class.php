                    ...
                    $out .= $this->get_avatar($post->author_id);
							...
							<td valign='top'>
								<table width='100%' cellspacing='0' cellpadding='0' class='wpf-meta-table'>
									...
									<tr>
										<td valign='top' colspan='2' class='topic_text'>".make_clickable(convert_smilies(wpautop($this->autoembed($this->output_filter($post->text)))))."</td>
									</tr>";
									if($user->description && $this->options['forum_show_bio']){
										$out .= "<tr><td class='user_desc'><small>".make_clickable(convert_smilies(wpautop($this->output_filter($user->description))))."</small></td></tr>";
									}
								$out .= "</table>
							</td>
						</tr>";
